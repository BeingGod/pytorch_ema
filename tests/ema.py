    ...
    def _get_parameters(
        ...
        if parameters is None:
            ...
            if len(parameters) != len(self.shadow_params):
                raise ValueError(
                    "Number of parameters passed as argument is different from number of shadow parameters maintained by this ExponentialMovingAverage"
                )
            return parameters
